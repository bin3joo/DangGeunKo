...
<img width="259" height="409" alt="image" src="https://github.com/user-attachments/assets/f702ada5-3e7b-48a3-aa2d-86f08f9bcad3" />
<img width="259" height="409" alt="image" src="https://github.com/user-attachments/assets/11788504-76ab-43cd-9bcc-d7dc718f3ad7" />
<img width="259" height="409" alt="image" src="https://github.com/user-attachments/assets/04325789-a350-4a0c-bcc1-116a61de0f01" />
...
### 4) 프론트 실행
```bash
cd FRONT_DangGeunKo/front-danggeunko
npm install
npm run dev
```

### 5) (선택) 지도 렌더러 실행
지도 렌더러(map-renderer)는 네이버 API 키가 필요한 선택 기능입니다. 실행 화면은 아래 실행 영상으로 확인해 주세요.
```bash
cd map-renderer
